# FreeElevation PHP SDK Reference

Complete API reference for the FreeElevation PHP SDK.
...
#### `FreeElevationSDK::test($testopts = null, $sdkopts = null)`
