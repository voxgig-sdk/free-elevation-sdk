...
// FreeElevation SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (FreeElevationSDK::test)
...
{
    private const SDK_CLASS = 'FreeElevationSDK';
    ...
    private const SDK_BASE = 'freeelevation_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../freeelevation_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
