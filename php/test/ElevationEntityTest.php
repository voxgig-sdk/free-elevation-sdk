...
class ElevationEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $cfg = FreeElevationConfig::shared_config();
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set FREE_ELEVATION_TEST_ELEVATION_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function elevation_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("FREE_ELEVATION_TEST_ELEVATION_ENTID");
