...
// FreeElevation SDK pipeline test
//
...
{
    private static function utility(): FreeElevationUtility
    {
        return new FreeElevationUtility();
    }
    ...
    private static function ctx(array $over = []): FreeElevationContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new FreeElevationContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new FreeElevationOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof FreeElevationError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new FreeElevationOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = FreeElevationMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new FreeElevationOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = FreeElevationMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new FreeElevationOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = FreeElevationMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new FreeElevationSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = FreeElevationMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new FreeElevationResponse([]),
            'result' => new FreeElevationResult([]),
        ]);
        [, $err] = FreeElevationMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new FreeElevationSpec([]),
            'response' => null,
            'result' => new FreeElevationResult([]),
        ]);
        [, $err] = FreeElevationMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new FreeElevationSpec(['step' => 's']),
            'response' => new FreeElevationResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new FreeElevationResult([]),
        ]);
        [, $err] = FreeElevationMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new FreeElevationSpec(['step' => 's']),
            'response' => new FreeElevationResponse(self::resp(200, ['v' => 1])),
            'result' => new FreeElevationResult([]),
        ]);
        [, $err] = FreeElevationMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new FreeElevationSpec(['step' => 's']),
            'response' => new FreeElevationResponse(self::resp(200, ['v' => 2])),
            'result' => new FreeElevationResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        FreeElevationMakeResponse::call($ctx);
    ...
    {
        $preset = new FreeElevationResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new FreeElevationSpec([]),
            'response' => new FreeElevationResponse([]),
            'result' => new FreeElevationResult([]),
        ...
        [$got, $err] = FreeElevationMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new FreeElevationResult([])]);
        [, $err] = FreeElevationMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new FreeElevationSpec([]), 'result' => null]);
        [, $err] = FreeElevationMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new FreeElevationSpec(['step' => 's']),
            'result' => new FreeElevationResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new FreeElevationOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = FreeElevationMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new FreeElevationSpec(['step' => 's']),
            'result' => new FreeElevationResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new FreeElevationOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = FreeElevationMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new FreeElevationResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new FreeElevationSpec([]),
            'result' => new FreeElevationResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = FreeElevationMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = FreeElevationMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new FreeElevationError('boom', 'boom');
        $utility->fetcher = function (FreeElevationContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new FreeElevationSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = FreeElevationMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (FreeElevationContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = FreeElevationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(FreeElevationResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        FreeElevationMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (FreeElevationContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new FreeElevationSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = FreeElevationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new FreeElevationResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new FreeElevationSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = FreeElevationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = FreeElevationMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = FreeElevationMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new FreeElevationResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, FreeElevationDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new FreeElevationResult(['ok' => false])]);
        $this->expectException(FreeElevationError::class);
        FreeElevationDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new FreeElevationResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', FreeElevationMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        FreeElevationMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new FreeElevationBaseFeature();
        $b = new FreeElevationBaseFeature();
        FreeElevationFeatureAdd::call($ctx, $a);
        FreeElevationFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): FreeElevationBaseFeature
    {
        $f = new FreeElevationBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        FreeElevationFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): FreeElevationContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new FreeElevationSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = FreeElevationPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        FreeElevationPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new FreeElevationResponse(['headers' => null]),
            'result' => new FreeElevationResult([]),
        ]);
        FreeElevationResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        FreeElevationResultBody::call($ctx);
