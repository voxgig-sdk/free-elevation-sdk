...
// FreeElevation SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = FreeElevationOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(FreeElevationOmni::structfix($now, Struct::undef()))
                        !== json_encode(FreeElevationOmni::structfix($val, Struct::undef()))) {
