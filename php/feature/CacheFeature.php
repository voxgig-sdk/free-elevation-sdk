...
// FreeElevation SDK cache feature
...
class FreeElevationCacheFeature extends FreeElevationBaseFeature
{
    ...
    private function _through(FreeElevationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
