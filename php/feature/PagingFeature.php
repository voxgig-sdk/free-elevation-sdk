...
// FreeElevation SDK paging feature
...
class FreeElevationPagingFeature extends FreeElevationBaseFeature
{
    ...
    private function _is_list(FreeElevationContext $ctx): bool
    {
