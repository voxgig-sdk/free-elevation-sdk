...
// FreeElevation SDK debug feature
...
class FreeElevationDebugFeature extends FreeElevationBaseFeature
{
    ...
    private function _finish(FreeElevationContext $ctx, bool $ok): void
    {
