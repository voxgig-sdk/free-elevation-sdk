...
// FreeElevation SDK idempotency feature
...
class FreeElevationIdempotencyFeature extends FreeElevationBaseFeature
{
    ...
    private function _mutating(FreeElevationContext $ctx): bool
    {
