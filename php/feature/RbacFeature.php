...
// FreeElevation SDK rbac feature
...
class FreeElevationRbacFeature extends FreeElevationBaseFeature
{
    ...
    private function _required(FreeElevationContext $ctx): ?string
    {
    ...
    private function _reject(FreeElevationContext $ctx, string $required): void
    {
    ...
    private function _track(FreeElevationContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
