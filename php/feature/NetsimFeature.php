...
// FreeElevation SDK netsim feature
...
class FreeElevationNetsimFeature extends FreeElevationBaseFeature
{
    ...
    private function _simulate(FreeElevationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(FreeElevationContext $ctx, array $applied): void
    {
        $client = $this->client;
