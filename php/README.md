# FreeElevation PHP SDK



The PHP SDK for the FreeElevation API — an entity-oriented client using PHP conventions.
...
print_r(array_map(fn($item) => $item->data_get(), $elevation));
```
...
```
php/
├── freeelevation_sdk.php          -- Main SDK class
...
The main class (`freeelevation_sdk.php`) exports the SDK class
