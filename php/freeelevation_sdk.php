...
class FreeElevationSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = FreeElevationHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = FreeElevationHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!FreeElevationFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, FreeElevationFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return FreeElevationUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = FreeElevationHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = FreeElevationHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = FreeElevationHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new FreeElevationError($op . "_allow",
                "FreeElevationSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = FreeElevationHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new FreeElevationError("graphql_error",
                "FreeElevationSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Elevation($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_elevation === null) {
                $this->_elevation = new ElevationEntity($this, null);
            }
            return $this->_elevation;
        }
        return new ElevationEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new FreeElevationSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
