...
// FreeElevation SDK utility: make_options

class FreeElevationMakeOptions
{
    ...
    public static function call(FreeElevationContext $ctx): array
    {
        ...
        //
        // `FreeElevationSchema::optspec()` is built from the model:
        ...
        $optspec = FreeElevationSchema::optspec();
