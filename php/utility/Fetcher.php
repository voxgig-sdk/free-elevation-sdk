...
// FreeElevation SDK utility: fetcher

class FreeElevationFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; FreeElevationSDK/1.0)';
    ...
    public static function call(FreeElevationContext $ctx, string $fullurl, array $fetchdef): array
    {
