...
#      offline in seeded test mode (FreeElevationSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "FreeElevation_sdk.rb")
  SDK_CLASS = "FreeElevationSDK"
