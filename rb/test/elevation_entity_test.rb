...
class ElevationEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set FREE_ELEVATION_TEST_ELEVATION_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def elevation_basic_setup(extra)
  ...
  entid_env_raw = ENV["FREE_ELEVATION_TEST_ELEVATION_ENTID"]
