...
func registerSDKWords(r *eng.Registry, client *sdk.FreeElevationSDK) {
...
func runOp(client *sdk.FreeElevationSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
