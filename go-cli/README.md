...
AQL-driven CLI and REPL for the FreeElevation SDK. Positional arguments are
...
./free-elevation-cli load 1 elevation
./free-elevation-cli load '{id:1}' elevation
