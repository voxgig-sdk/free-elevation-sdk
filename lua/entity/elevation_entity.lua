...
local ElevationEntity = {}
ElevationEntity.__index = ElevationEntity


function ElevationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ElevationEntity)
  self._name = "elevation"
  self._client = client
...
function ElevationEntity:get_name()
  return self._name
end


function ElevationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ElevationEntity.new(self._client, opts)
end
...
function ElevationEntity:mark_deleted()
  self._deleted = true
end


function ElevationEntity:deleted()
  return true == self._deleted
end


function ElevationEntity:data_set(args)
  if args ~= nil then
...
function ElevationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ElevationEntity:match_set(args)
  if args ~= nil then
...
function ElevationEntity:match_get()
...
function ElevationEntity:stream(action, args, callopts)
...
---@param reqmatch ElevationLoadMatch
---@param ctrl? table
---@return Elevation
---@return string? err
function ElevationEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ElevationListMatch
---@param ctrl? table
---@return Elevation[]
---@return string? err
function ElevationEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function ElevationEntity:_run_op(ctx, post_done)
  local utility = self._utility
