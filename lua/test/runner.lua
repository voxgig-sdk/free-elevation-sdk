...
function runner.env_override(m)
  local live = runner.getenv("FREEELEVATION_TEST_LIVE")
  local override = runner.getenv("FREEELEVATION_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("FREEELEVATION_TEST_EXPLAIN")
