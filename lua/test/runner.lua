...
function runner.env_override(m)
  local live = runner.getenv("FREE_ELEVATION_TEST_LIVE")
  local override = runner.getenv("FREE_ELEVATION_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("FREE_ELEVATION_TEST_EXPLAIN")
