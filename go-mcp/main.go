// Command FreeElevation-mcp is an MCP server exposing the FreeElevation
// SDK as MCP tools.
//
// Two tools are registered:
//
//	FreeElevation_list  — list records of an entity
//	FreeElevation_load  — load a single record of an entity
//
