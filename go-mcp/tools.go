...
type Args struct {
	Entity string         `json:"entity" jsonschema:"elevation"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.FreeElevationSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "free-elevation_list",
		Description: "List records from FreeElevation. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "free-elevation_load",
		Description: "Load a single record from FreeElevation. " +
...
func runOp(client *sdk.FreeElevationSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.FreeElevationSDK, name string) (sdk.FreeElevationEntity, error) {
	switch strings.ToLower(name) {
	case "elevation":
		return client.Elevation(nil), nil
