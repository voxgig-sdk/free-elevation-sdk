...
|---|---|---|
| `ts/` | @voxgig-sdk/free-elevation-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/free-elevation-sdk \
      --repository voxgig-sdk/free-elevation-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/free-elevation-sdk` shows it, and
`npm trust revoke @voxgig-sdk/free-elevation-sdk --id=<id>` removes it.
