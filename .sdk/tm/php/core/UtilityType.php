...
// FreeElevation SDK utility type

class FreeElevationUtility
{
    ...
    public static function copy(FreeElevationUtility $src): FreeElevationUtility
    {
        $u = new FreeElevationUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
