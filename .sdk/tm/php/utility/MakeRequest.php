...
// FreeElevation SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class FreeElevationMakeRequest
{
    public static function call(FreeElevationContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new FreeElevationResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new FreeElevationResponse($fetched);
        } else {
