...
// FreeElevation SDK utility: graphql
//
...
class FreeElevationGraphql
{
    ...
    // equivalent.
    public static function body(FreeElevationContext $ctx): mixed
    {
    ...
    public static function errors(FreeElevationContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
