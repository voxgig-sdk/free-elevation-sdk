...
// FreeElevation SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class FreeElevationTransformResponse
{
    public static function call(FreeElevationContext $ctx): mixed
    {
        ...
        $transform = FreeElevationHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
