...
// FreeElevation SDK proxy feature
...
class FreeElevationProxyFeature extends FreeElevationBaseFeature
{
    ...
    public function init(FreeElevationContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (FreeElevationContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
