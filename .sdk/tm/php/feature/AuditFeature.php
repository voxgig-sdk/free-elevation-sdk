...
// FreeElevation SDK audit feature
...
class FreeElevationAuditFeature extends FreeElevationBaseFeature
{
    ...
    private function _emit(FreeElevationContext $ctx, string $outcome): void
    {
