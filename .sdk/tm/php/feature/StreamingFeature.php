...
// FreeElevation SDK streaming feature
...
class FreeElevationStreamingFeature extends FreeElevationBaseFeature
{
    ...
    private function _iterate(FreeElevationResult $result): \Generator
    {
    ...
    private function _streamable(FreeElevationContext $ctx): bool
    {
