...
// FreeElevation SDK metrics feature
...
class FreeElevationMetricsFeature extends FreeElevationBaseFeature
{
    ...
    private function _record(FreeElevationContext $ctx, bool $ok): void
    {
