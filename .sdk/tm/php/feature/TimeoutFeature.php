...
// FreeElevation SDK timeout feature
...
class FreeElevationTimeoutFeature extends FreeElevationBaseFeature
{
    ...
    private function _with_timeout(FreeElevationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(FreeElevationContext $_ctx, float $ms): void
    {
        $client = $this->client;
