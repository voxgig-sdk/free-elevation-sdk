...
// FreeElevation SDK telemetry feature
...
class FreeElevationTelemetryFeature extends FreeElevationBaseFeature
{
    ...
    private function _close(FreeElevationContext $ctx, bool $ok): void
    {
