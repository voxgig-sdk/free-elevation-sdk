...
// FreeElevation SDK ratelimit feature
...
class FreeElevationRatelimitFeature extends FreeElevationBaseFeature
{
    ...
    private function _acquire(FreeElevationContext $ctx): void
    {
    ...
    private function _track(FreeElevationContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
