...
from freeelevation_sdk.utility import register

# Load features
from freeelevation_sdk.feature.base_feature import FreeElevationBaseFeature
from freeelevation_sdk.features import _has_feature, _make_feature
...
class FreeElevationSDK:
    ...
    def get_utility(self):
        return FreeElevationUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("FreeElevationSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Elevation(self, data=None) -> "ElevationEntity":
        ...
        from freeelevation_sdk.entity.elevation_entity import ElevationEntity
