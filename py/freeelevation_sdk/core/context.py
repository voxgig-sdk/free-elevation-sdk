...
from freeelevation_sdk.core.helpers import get_ctx_prop, to_map
...
class FreeElevationContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = FreeElevationControl()
        ...
        if isinstance(sp, FreeElevationSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, FreeElevationResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, FreeElevationResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return FreeElevationError(code, msg, self)
