...
class FreeElevationTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FreeElevationTestRunner.getenv("FREEELEVATION_TEST_LIVE")
        override = FreeElevationTestRunner.getenv("FREEELEVATION_TEST_OVERRIDE")
        ...
        explain = FreeElevationTestRunner.getenv("FREEELEVATION_TEST_EXPLAIN")
