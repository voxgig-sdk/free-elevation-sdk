# FreeElevation SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions FreeElevationSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both FreeElevationSDK(...) and FreeElevationSDK.test(...) become
#      FreeElevationSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "freeelevation_sdk"
_SDK_CLASS = "FreeElevationSDK"
