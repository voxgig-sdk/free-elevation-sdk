...
func NewElevationEntity(client *core.FreeElevationSDK, entopts map[string]any) *ElevationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ElevationEntity) GetName() string { return e.name }
...
func (e *ElevationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ElevationEntity) Deleted() bool {
	return e.deleted
}


func (e *ElevationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewElevationEntity(e.client, opts)
}

func (e *ElevationEntity) Data(args ...any) any {
...
func (e *ElevationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Elevation; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ElevationEntity) DataTyped(data ...Elevation) Elevation {
	if len(data) > 0 {
		return typedFrom[Elevation](e.Data(asMap(data[0])))
	}
	return typedFrom[Elevation](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Elevation (all fields
// optional at the wire level).
func (e *ElevationEntity) MatchTyped(match ...Elevation) Elevation {
	if len(match) > 0 {
		return typedFrom[Elevation](e.Match(asMap(match[0])))
	}
	return typedFrom[Elevation](e.Match())
}
...
func (e *ElevationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ElevationEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ElevationLoadMatch and returns an Elevation. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ElevationEntity) LoadTyped(reqmatch ElevationLoadMatch, ctrl map[string]any) (Elevation, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Elevation{}, err
	}
	return typedFrom[Elevation](res), nil
}




func (e *ElevationEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// ElevationListMatch and returns []Elevation. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ElevationEntity) ListTyped(reqmatch ElevationListMatch, ctrl map[string]any) ([]Elevation, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Elevation](res), nil
}



func (e *ElevationEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ElevationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ElevationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ElevationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
