...
func (sdk *FreeElevationSDK) OptionsMap() map[string]any {
...
func (sdk *FreeElevationSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *FreeElevationSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *FreeElevationSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FreeElevationSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *FreeElevationSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *FreeElevationSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("FreeElevationSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *FreeElevationSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FreeElevationSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("FreeElevationSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *FreeElevationSDK {
	...
	sdk := NewFreeElevationSDK(sdkopts)
	sdk.Mode = "test"
